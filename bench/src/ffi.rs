...
pub use vanedb_capi::{
    ...
    vanedb_rs_disk_search, vanedb_rs_disk_search_filtered, vanedb_rs_dot_product,
    vanedb_rs_index_add, vanedb_rs_index_free, vanedb_rs_index_new, vanedb_rs_index_search,
    vanedb_rs_index_search_filtered, vanedb_rs_l2_sq, vanedb_rs_store_add, vanedb_rs_store_free,
    vanedb_rs_store_new, vanedb_rs_store_search, vanedb_rs_store_search_filtered,
};
