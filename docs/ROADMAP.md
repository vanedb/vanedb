...
| 8 | [0008 Streaming disk build and mapped graph](rfcs/0008-streaming-disk-build-and-mapped-graph.md) | 0.4.0 | draft; direction accepted, gated on the [capacity study](research/2026-09-capacity-study.md) |
